...
for i=1:length(gts)
    ...
    % raw prediction
    plot3([0,pred(1,1)],[0,pred(1,2)],[0,pred(1,3)],'r', 'LineWidth', 2)
    hold on
    plot3([0,pred(2,1)],[0,pred(2,2)],[0,pred(2,3)],'g', 'LineWidth', 2)
    hold on
    plot3([0,pred(3,1)],[0,pred(3,2)],[0,pred(3,3)],'b', 'LineWidth', 2)

    % reorthogonalized prediction
    plot3([0,ortho_pred(1,1)],[0,ortho_pred(1,2)],[0,ortho_pred(1,3)],'--r', 'LineWidth', 2)
    hold on
    plot3([0,ortho_pred(2,1)],[0,ortho_pred(2,2)],[0,ortho_pred(2,3)],'--g', 'LineWidth', 2)
    hold on
    plot3([0,ortho_pred(3,1)],[0,ortho_pred(3,2)],[0,ortho_pred(3,3)],'--b', 'LineWidth', 2)

    %ground truth
    plot3([0,gt(1,1)],[0,gt(1,2)],[0,gt(1,3)],'Color', [0.8500 0.3250 0.0980], 'LineWidth', 2)
    hold on
    plot3([0,gt(2,1)],[0,gt(2,2)],[0,gt(2,3)],'Color', [0.4660 0.6740 0.1880], 'LineWidth', 2)
    hold on
    plot3([0,gt(3,1)],[0,gt(3,2)],[0,gt(3,3)],'Color', [0 0.4470 0.7410], 'LineWidth', 2)
